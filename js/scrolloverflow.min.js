...
! function (n, r, p) {
    ...
    function t(t, i) {
        for (var s in this.wrapper = "string" == typeof t ? r.querySelector(t) : t, this.scroller = this.wrapper.children[0], this.scrollerStyle = this.scroller.style, this.options = {
                resizeScrollbars: !0,
                mouseWheelSpeed: 20,
                snapThreshold: .334,
    ...
    function a(t, i) {
        for (var s in this.wrapper = "string" == typeof i.el ? r.querySelector(i.el) : i.el, this.wrapperStyle = this.wrapper.style, this.indicator = this.wrapper.children[0], this.indicatorStyle = this.indicator.style, this.scroller = t, this.options = {
                listenX: !0,
                listenY: !0,
                interactive: !1,
                resize: !0,
    ...
    t.prototype = {
        ...
        _initEvents: function (t) {
            ...
            i(n, "orientationchange", this), i(n, "resize", this), this.options.click && i(this.wrapper, "click", this, !0), this.options.disableMouse || (i(this.wrapper, "mousedown", this), i(s, "mousemove", this), i(s, "mousecancel", this), i(s, "mouseup", this)), m.hasPointer && !this.options.disablePointer && (i(this.wrapper, m.prefixPointerEvent("pointerdown"), this), i(s, m.prefixPointerEvent("pointermove"), this), i(s, m.prefixPointerEvent("pointercancel"), this), i(s, m.prefixPointerEvent("pointerup"), this)), m.hasTouch && !this.options.disableTouch && (i(this.wrapper, "touchstart", this), i(s, "touchmove", this), i(s, "touchcancel", this), i(s, "touchend", this)), i(this.scroller, "transitionend", this), i(this.scroller, "webkitTransitionEnd", this), i(this.scroller, "oTransitionEnd", this), i(this.scroller, "MSTransitionEnd", this)
        },
        getComputedPosition: function () {
            var t, i, s = n.getComputedStyle(this.scroller, null);
        ...
        _initKeys: function (t) {
            ...
            m.addEvent(n, "keydown", this), this.on("destroy", function () {
        ...
        destroy: function () {
            this.options.fadeScrollbars && (clearTimeout(this.fadeTimeout), this.fadeTimeout = null), this.options.interactive && (m.removeEvent(this.indicator, "touchstart", this), m.removeEvent(this.indicator, m.prefixPointerEvent("pointerdown"), this), m.removeEvent(this.indicator, "mousedown", this), m.removeEvent(n, "touchmove", this), m.removeEvent(n, m.prefixPointerEvent("pointermove"), this), m.removeEvent(n, "mousemove", this), m.removeEvent(n, "touchend", this), m.removeEvent(n, m.prefixPointerEvent("pointerup"), this), m.removeEvent(n, "mouseup", this)), this.options.defaultScrollbars && this.wrapper.parentNode.removeChild(this.wrapper)
        },
        _start: function (t) {
        ...
        _end: function (t) {
            if (this.initiated) {
                if (this.initiated = !1, t.preventDefault(), t.stopPropagation(), m.removeEvent(n, "touchmove", this), m.removeEvent(n, m.prefixPointerEvent("pointermove"), this), m.removeEvent(n, "mousemove", this), this.scroller.options.snap) {
...
function (l, f) {
    l.fp_scrolloverflow = function () {
        l.IScroll || (IScroll = module.exports);
        var s = "fp-scrollable",
            n = "." + s,
            t = ".active",
            p = ".fp-section",
        ...
        function r() {
            ...
            function s() {
                var i;
                fp_utils.hasClass(f.body, "fp-responsive") ? (i = c.options.scrollOverflowHandler, e(function (t) {
                    fp_utils.hasClass(fp_utils.closest(t, p), "fp-auto-height-responsive") && i.remove(t)
                })) : e(t)
            }
            ...
            function t(t) {
                if (!fp_utils.hasClass(t, "fp-noscroll")) {
                    ...
                    var i, s, e, o = c.options.scrollOverflowHandler,
                        n = o.wrapContent(),
                        r = fp_utils.closest(t, p),
                        h = o.scrollable(t),
                        a = (s = r, null != (e = fp_utils.closest(s, p)) ? parseInt(getComputedStyle(e)["padding-bottom"]) + parseInt(getComputedStyle(e)["padding-top"]) : 0);
                    null != h ? i = o.scrollHeight(t) : (i = t.scrollHeight - a, c.options.verticalCentered && (i = u(d, t)[0].scrollHeight - a));
                    var l = fp_utils.getWindowHeight() - a;
                    l < i ? null != h ? o.update(t, l) : (c.options.verticalCentered ? (fp_utils.wrapInner(u(d, t)[0], n.scroller), fp_utils.wrapInner(u(d, t)[0], n.scrollable)) : (fp_utils.wrapInner(t, n.scroller), fp_utils.wrapInner(t, n.scrollable)), o.create(t, l, c.iscrollOptions)) : o.remove(t), fp_utils.css(t, {
                        overflow: ""
                    })
                }
            }
            ...
            c.options = null, c.init = function (t, i) {
                return c.options = t, c.iscrollOptions = i, "complete" === f.readyState && (s(), fullpage_api.shared.afterRenderActions()), l.addEventListener("load", function () {
            ...
            a = {
                ...
                remove: function (t) {
                    if (null != t) {
                        ...
                        if (null != i) {
                            var s = i.fp_iscrollInstance;
                            null != s && s.destroy(), i.fp_iscrollInstance = null, fp_utils.unwrap(u(".fp-scroller", t)[0]), fp_utils.unwrap(u(n, t)[0])
                        }
                    }
                },
                update: function (t, i) {
                    clearTimeout(a.refreshId), a.refreshId = setTimeout(function () {
                        a.iScrollInstances.forEach(function (t) {
                            t.refresh(), fullpage_api.silentMoveTo(fp_utils.index(u(e)[0]) + 1)
                        })
                    }, 150), fp_utils.css(u(n, t)[0], {
                        height: i + "px"
